...
[![License](https://img.shields.io/github/license/Minespree/Pirate.svg)](LICENSE)
...
This project depends on these modules, so they should also be built and placed on your `plugins/` directory before running Pirate:
